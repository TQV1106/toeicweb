									...
									<div class="widget-body">
										<div class="widget-main">
											<h4 class="header blue lighter bigger">
												...
												Thêm ảnh cho bài tập nghe
											</h4>

											<div class="space-6"></div>

											<form action="Themhinhbtnghe?listenexerciseid=<%=request.getAttribute("listenexerciseid")%>" method="POST" enctype="multipart/form-data">
												<fieldset>
													...
													<div class="clearfix">
														...
														<button type="submit" class="width-70 pull-right btn btn-sm btn-primary">
															...
															<span class="bigger-110">Thêm ảnh bài tập nghe</span>
														</button>
